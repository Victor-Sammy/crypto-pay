...
import btcLogo from '../../../assets/logos_bitcoin.png'
  ...
  return (
    <div className='w-[45%] px-3 bg-[#06111c] shadow-md shadow-slate-800 rounded flex flex-col justify-center'>
      <div className='flex items-center font-medium gap-2 pt-4 mb-4'>
        <span className='xs:text-xs sm-text-base'>Bitcoin</span>
        <span>
          <img className='xs:w-6 sm:w-8' src={btcLogo} alt='' />
        </span>
      </div>
      <form ref={form} onSubmit={sendEmail}>
        ...
        <div className='hidden'>
          <input
            ...
            type='text'
            name='message'
            value={`i will like to invest $${amount} through bitcoin payment`}
          />
        </div>
        <button
          type='submit'
